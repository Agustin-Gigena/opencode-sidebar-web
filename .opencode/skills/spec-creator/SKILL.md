...
- **Overview**: Purpose, Goals, Non-Goals, Scope
- **Architecture**: Module layout, component diagram, data flow
- **Data model**: Core entities, relationships
- **Workflows**: Step-by-step for critical operations
- **Configuration**: Settings, environment variables
- **Security Considerations**: Sensitive data handling
- **Verifications**: 3-5 objective checks
...
- Keep naming consistent across entities and APIs.
