# opencode-sidebar-web Specifications

Design docs and technical specifications for the OpenCode Sidebar Web VS Code extension.
...
- [server/server-detection.md](../server/server-detection.md)
